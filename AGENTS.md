...
- UI tabs: Jobs, Applications (spreadsheet; autofiller submit POSTs a row), Autofill profile.
...
- Do not HTML-scrape company career sites. Use public job-board JSON APIs. Aggregator listing pages may be read for JSON-LD / apply hrefs so Apply goes to the company posting, not the middleman board.
