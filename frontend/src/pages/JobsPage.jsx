...
import { appliedFromJob } from "../lib/applied.js";
import { isJobApplied } from "../lib/applicationsApi.js";
...
export default function JobsPage({ appliedJobs, onAppliedJobsChange }) {
  ...
  function markApplied(job) {
    onAppliedJobsChange(appliedFromJob(job));
  }

  return (
    <>
      <p className="subtitle">
        Internships and new-grad roles from community feeds and company career boards — not just tech
      </p>
      ...
      */}
      ...
      {!loading && !error && jobs.length > 0 && (
        <ul className="job-list">
          {jobs.map((job) => {
            const alreadyApplied = isJobApplied(job, appliedJobs);
            return (
